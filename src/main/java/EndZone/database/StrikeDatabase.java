...
public class StrikeDatabase {
    ...
    public void setDemotionListMessageId(String messageId) {
        if (messageId == null) {
            removeMetadata("demotion_list_message_id");
            return;
        }
        String sql = "INSERT INTO bot_metadata (key, value) " +
    ...
    private void removeMetadata(String key) {
        ...
        try (Connection conn = DatabaseService.getConnection();
            ...
            System.err.println("Error removing metadata key " + key + ": " + e.getMessage());
        }
    }
    ...
    public void editStrikeReason(String userId, Timestamp date, String newReason) {
