...
public class PermissionUtils {
    ...
    public static boolean isBotOwner(User user) {
        return user != null && user.getId().equals(BotConfig.OWNER_USER_ID);
    }

    public static boolean isBotOwner(Member member) {
        return member != null && member.getId().equals(BotConfig.OWNER_USER_ID);
    }
    ...
    public static boolean canModerate(Member moderator, Member target) {
        ...
        // Bot owner can always moderate anyone else
        if (isBotOwner(moderator)) return true;
