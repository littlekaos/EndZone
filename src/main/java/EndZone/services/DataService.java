...
public class DataService {
    ...
    public record MuteEntry(String guildId, String userId) {}
    ...
    public record MessageLogEntry(String userId, String content) {}
    ...
    public record RestrictionEntry(String channelId, String type) {}
    ...
    public void setStaffAnnouncementsEnabled(boolean enabled) {
        setMetadata("staff_announcements_enabled", String.valueOf(enabled));
    }
    ...
    public void setWeeklyAnnouncementEnabled(boolean enabled) {
        setMetadata("weekly_announcement_enabled", String.valueOf(enabled));
    }
    ...
    public void setMondayAnnouncementEnabled(boolean enabled) {
        setMetadata("monday_announcement_enabled", String.valueOf(enabled));
    }
    ...
    public record WinnerMessageEntry(String messageId, String channelId, String guildId) {}
}
